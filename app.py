...
class Venue(db.Model):
    ...
    image_link = db.Column(db.String(500), nullable=False, default='https://www.visitcalifornia.com/sites/default/files/VC_HistoricMusicVenues_Stock_ED_D19CGP_1280x640.jpg')
...
class Artist(db.Model):
    ...
    phone = db.Column(db.String(120), nullable=False)
    genres = db.Column(db.String(120))
    image_link = db.Column(db.String(500), nullable=False, default='https://thumbs.dreamstime.com/z/teen-rock-band-5708597.jpg')
    facebook_link = db.Column(db.String(120))
    website = db.Column(db.String(500))
...
def show_venue(venue_id):
  ...
  for i in range(len(venues)):
    ...
    venue_list.append({
      "id": venues[i].id,
      "name": venues[i].name,
      "genres": venues[i].genres.strip("}").strip("{").split(','),
      "city": venues[i].city,
      "state": venues[i].state,
...
def show_artist(artist_id):
  ...
  for i in range(len(artists)):
    ...
    artist_list.append({
      "id": artists[i].id,
      "name": artists[i].name,
      "genres": artists[i].genres.strip("}").strip("{").split(','),
      "city": artists[i].city,
